...
public class AIActivity extends Activity {
    ...
    private void loadResources() {
        drawCell[3] = context.getResources().getDrawable(R.drawable.o);//background
        //copy 2 image for 2 drawable player and bot
        //edit it :D
        drawCell[0] = null;//empty cell
        drawCell[1] = context.getResources().getDrawable(R.drawable.x_cell);//drawable for player
        drawCell[2] = context.getResources().getDrawable(R.drawable.o_cell);//for bot
    }
